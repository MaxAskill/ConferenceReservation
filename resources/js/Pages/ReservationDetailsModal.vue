<template>
  <div
    ...
    class="overflow-x-hidden overflow-y-auto fixed inset-0 outline-none focus:outline-none md:justify-center md:items-center flex bg-black bg-opacity-50 p-12"
  >
    <div class="relative my-auto mx-auto max-w-full px-2 md:px-0">
      ...
      >
        ...
        >
          <h1 class="text-lg font-bold">Reservation Details</h1>
          <el-button
            class="ml-auto"
            size="small"
            type="danger"
        ...
        <div class="relative px-2 md:px-5 py-3 flex-auto">
          <div class="grid grid-cols-3 gap-4">
            <div class="relative">
              <label class="text-gray-500 text-sm">Conference Room</label><br />
              <div
                class="bg-gray-50 w-full px-2 py-1 rounded border border-gray-200 text-gray-600"
              >
                {{ reservationInformation.conferenceRoom }}
              </div>
            </div>
            <div class="relative">
              <div class="">
            ...
            <div class="relative">
              <label class="text-gray-500 text-sm">Time Slot</label>
              <div
                class="bg-gray-50 w-full px-2 py-1 rounded border border-gray-200 text-gray-600"
              >
                {{ reservationInformation.timeSlot }}
              </div>
            </div>
            <div class="relative">
            ...
            <div class="relative">
              ...
              <div
                class="bg-gray-50 w-full px-2 py-1 rounded border border-gray-200 text-gray-600"
              >
                {{ reservationInformation.department }}
              </div>
            </div>
            <div class="relative">
              ...
              <div
                class="bg-gray-50 w-full px-2 py-1 rounded border border-gray-200 text-gray-600"
              >
                {{ reservationInformation.purpose }}
              </div>
            </div>
            <div class="relative">
              ...
              <div
                class="bg-gray-50 w-full px-2 py-1 rounded border border-gray-200 text-gray-600"
              >
                {{ reservationInformation.equipment }}
              </div>
            </div>
            <div class="relative">
              <label class="text-gray-500 text-sm">Chairs and Tables Arrangement</label>
              <div
                class="bg-gray-50 w-full px-2 py-1 rounded border border-gray-200 text-gray-600"
              >
                {{ reservationInformation.arrangement }}
              </div>
            </div>
          </div>
        </div>
